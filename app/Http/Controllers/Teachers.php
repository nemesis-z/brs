...
class teachers extends Controller {
	...
	public function setMark(Request $request,App\Lesson $lesson,App\Group $group,App\Student $student) {
		// if($this->user->id!=260)return $this->err('Система закрыта');
		...
		if($this->user->id!=260 && $d[1]>10 && ($request->type=='t1'||$request->type=='r1'))return $this->err('Поздно вносить правки за 1-ый семестр :(');
